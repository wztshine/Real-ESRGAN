...
```shell
# 推荐使用
python inference_realesrgan_video.py -i ./inputs/video/onepiece_demo.mp4 -n RealESRGAN_x2plus -s 1.5 -t 1000

# 注意：如果上面的脚本生成的视频有问题，或根本不能生成视频，可以尝试用下面的脚本命令；
python inference_video.py -i ./inputs/video/onepiece_demo.mp4 -n RealESRGAN_x2plus -s 1.5 -t 1000
```
